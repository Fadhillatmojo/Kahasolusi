    ...
    <form method="POST" action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
        ...
        <table id="table-form" class="w-100">
            <tr>
                ...
                <td>
                    <input type="text" class="form-control @error('testimonial_client') is invalid @enderror" id="testimonial_client" name="testimonial_client" placeholder="Client Name">
            ...
            <tr>
                ...
                <td>
                    <textarea class="form-control" placeholder="Description" id="testimonial_desc" name="testimonial_desc" rows="5"></textarea>
                ...
                <td>
                    <table id="table-radio" class="">
                        <tr>
                            @for ($i = 5; $i >= 1; $i--)
								<td>
									<input type="radio" id="star{{ $i }}" name="testimonial_rate" value="{{ $i }}">
								</td>
							@endfor
                        </tr>
                        <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="file" class="form-control" id="testimonial_image_url" name="testimonial_image_url" value="">
