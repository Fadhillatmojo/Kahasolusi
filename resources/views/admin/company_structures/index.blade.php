                    ...
                    <td class="text-center align-middle none-border-right index">
                        <div class="d-flex justify-content-center">
                            ...
                            <form id="deleteForm_{{ $founder->person_id }}" action="{{ route('founders.destroy', $founder->person_id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button" id="btn-delete" onclick="showDeleteConfirmation('{{ $founder->person_id }}')"><img src="{{ asset('../adminassets/img/global/action/iconActionDelete.svg') }}"></button>
                            </form>
                        </div>
                    </td>
                </tr>
