            ...
            <div class="row-footer row-cols-1 row-cols-lg-3 ">
                <div class="col-lg-5 col-md-6 item">
                    <div class="f-item about">
                        ...
                        <p>
                            HEADQUARTER<br>Pucung 001/001 Tamanmartani Kalasan Sleman Yogyakarta<br>Telp. 085293037949
                        </p>
                        <p>
                            JAKARTA OFFICE<br>Virtual Office
                        </p>
                        <p>
                            Email: info@kahasolusi.com<br>Website: kahasolusi.com
                        </p>
            ...
            <div class="footer-bottom-box">
                <div class="row footer-bottom-row">
                    <div class="col-lg-7 d-flex justify-content-center text-center">
                        <p class="d-inline">&copy; Copyright 2023<br>All Rights Reserved by Kahasolusi</p>
                    </div>
                </div>
            </div>
        </div>
